...
class OpenXRInteractionProfileMetadata(py4godot_object.Object):
  ...
  @functools.native_method
  def register_path_rename(self, old_name:'str'   , new_name:'str'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(50,tuple([py_string_old_name._ptr, py_string_new_name._ptr]))

  @functools.native_method
  def register_top_level_path(self, display_name:'str'   , openxr_path:'str'   , openxr_extension_names:'str'   ) -> None:
    r''''''
    ...
    assert(not openxr_extension_names is None)
    assert isinstance(openxr_extension_names, (str, String)), 'openxr_extension_names must be str or String'
    ...
    assert(isinstance(openxr_extension_names, (str, String)))
    py_string_openxr_extension_names = openxr_extension_names if isinstance(openxr_extension_names, StringName) else c_utils.py_string_to_string(openxr_extension_names)

    self._ptr.call_with_return(51,tuple([py_string_display_name._ptr, py_string_openxr_path._ptr, py_string_openxr_extension_names._ptr]))

  @functools.native_method
  def register_interaction_profile(self, display_name:'str'   , openxr_path:'str'   , openxr_extension_names:'str'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(52,tuple([py_string_display_name._ptr, py_string_openxr_path._ptr, py_string_openxr_extension_names._ptr]))

  @functools.native_method
  def register_io_path(self, interaction_profile:'str'   , display_name:'str'   , toplevel_path:'str'   , openxr_path:'str'   , openxr_extension_names:'str'   , action_type:'int'  ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(53,tuple([py_string_interaction_profile._ptr, py_string_display_name._ptr, py_string_toplevel_path._ptr, py_string_openxr_path._ptr, py_string_openxr_extension_names._ptr, action_type]))
