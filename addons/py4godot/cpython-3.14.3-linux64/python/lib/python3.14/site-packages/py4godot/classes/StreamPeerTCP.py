...
class StreamPeerTCP(py4godot_streampeersocket.StreamPeerSocket):
  r'''
  ...
  def bind(self, port:'int'   , host:'str' ="*"  ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(91,tuple([port, py_string_host._ptr]))
    return _ret
  ...
  def connect_to_host(self, host:'str'   , port:'int'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = self._ptr.call_with_return(92,tuple([py_string_host._ptr, port]))
    return _ret
