...
class Window(py4godot_viewport.Viewport):
  ...
  def constructor():
    ...
    class_._ptr = constructor(1058,0, ())
    return class_
  @staticmethod
  def new():
    class_ = Window.construct_without_init()
  ...
  @functools.native_method
  def get_theme_stylebox(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union['py4godot_styleboxtexture.StyleBoxTexture','py4godot_stylebox.StyleBox','py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxline.StyleBoxLine','py4godot_styleboxempty.StyleBoxEmpty']:
    r'''
  ...
  @functools.native_method
  def get_theme_font(self, name:'object'   , theme_type:'object' = None  ) -> typing.Union['py4godot_systemfont.SystemFont','py4godot_font.Font','py4godot_fontvariation.FontVariation','py4godot_fontfile.FontFile']:
    r'''
  ...
  @functools.native_method
  def get_theme_default_font(self) -> typing.Union['py4godot_systemfont.SystemFont','py4godot_font.Font','py4godot_fontvariation.FontVariation','py4godot_fontfile.FontFile']:
    r'''
  ...
  def get_focused_window() -> typing.Any:
    ...
    _ret._ptr = static_method(1058,2,tuple([]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
