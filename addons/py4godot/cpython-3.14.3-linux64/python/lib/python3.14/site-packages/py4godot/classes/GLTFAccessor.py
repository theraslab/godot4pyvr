...
class GLTFAccessor(py4godot_resource.Resource):
  ...
  def from_dictionary(dictionary:'Dictionary'   ) -> typing.Union['typing.Self']:
    ...
    _ret = GLTFAccessor.construct_without_init()
    _ret._ptr = static_method(354,1,tuple([dictionary._ptr]))
  ...
  def set_buffer_view(self, buffer_view:'int'   ) -> None:
    ...
    self._ptr.call_with_return(79,tuple([buffer_view]))
  ...
  def set_component_type(self, component_type:'int'  ) -> None:
    ...
    self._ptr.call_with_return(83,tuple([component_type]))
  ...
  def set_normalized(self, normalized:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(85,tuple([normalized]))
  ...
  def set_accessor_type(self, accessor_type:'int'  ) -> None:
    ...
    self._ptr.call_with_return(89,tuple([accessor_type]))
  ...
  def set_type(self, type:'int'   ) -> None:
    ...
    self._ptr.call_with_return(91,tuple([type]))
  ...
  def set_min(self, min:'PackedFloat64Array'   ) -> None:
    ...
    self._ptr.call_with_return(93,tuple([min._ptr]))
  ...
  def set_max(self, max:'PackedFloat64Array'   ) -> None:
    ...
    self._ptr.call_with_return(95,tuple([max._ptr]))
  ...
  def set_sparse_count(self, sparse_count:'int'   ) -> None:
    ...
    self._ptr.call_with_return(97,tuple([sparse_count]))
  ...
  def set_sparse_indices_buffer_view(self, sparse_indices_buffer_view:'int'   ) -> None:
    ...
    self._ptr.call_with_return(99,tuple([sparse_indices_buffer_view]))
  ...
  def set_sparse_indices_byte_offset(self, sparse_indices_byte_offset:'int'   ) -> None:
    ...
    self._ptr.call_with_return(101,tuple([sparse_indices_byte_offset]))
  ...
  def set_sparse_indices_component_type(self, sparse_indices_component_type:'int'  ) -> None:
    ...
    self._ptr.call_with_return(103,tuple([sparse_indices_component_type]))
  ...
  def set_sparse_values_buffer_view(self, sparse_values_buffer_view:'int'   ) -> None:
    ...
    self._ptr.call_with_return(105,tuple([sparse_values_buffer_view]))
  ...
  def set_sparse_values_byte_offset(self, sparse_values_byte_offset:'int'   ) -> None:
    ...
    self._ptr.call_with_return(107,tuple([sparse_values_byte_offset]))
