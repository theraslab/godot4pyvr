...
class AnimatedSprite2D(py4godot_node2d.Node2D):
  ...
  def set_sprite_frames(self, sprite_frames:'py4godot_spriteframes.SpriteFrames'   ) -> None:
    ...
    self._ptr.call_with_return(305,tuple([sprite_frames._ptr]))
  ...
  def set_animation(self, name:'object'   ) -> None:
    ...
    self._ptr.call_with_return(307,tuple([py_stringname_name._ptr]))
  ...
  def set_autoplay(self, name:'str'   ) -> None:
    ...
    self._ptr.call_with_return(309,tuple([py__string_name._ptr]))
  ...
  def play(self, name:'object' = None  , custom_speed:'float' =1.0  , from_end:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(312,tuple([py_stringname_name._ptr, custom_speed, from_end]))
  ...
  def play_backwards(self, name:'object' = None  ) -> None:
    ...
    self._ptr.call_with_return(313,tuple([py_stringname_name._ptr]))
  ...
  def pause(self) -> None:
    ...
    self._ptr.call_with_return(314,tuple([]))
  ...
  def set_centered(self, centered:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(316,tuple([centered]))
  ...
  def set_offset(self, offset:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(318,tuple([offset._ptr]))
  ...
  def set_flip_h(self, flip_h:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(320,tuple([flip_h]))
  ...
  def set_flip_v(self, flip_v:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(322,tuple([flip_v]))
  ...
  def set_frame(self, frame:'int'   ) -> None:
    ...
    self._ptr.call_with_return(324,tuple([frame]))
  ...
  def set_frame_progress(self, progress:'float'   ) -> None:
    ...
    self._ptr.call_with_return(326,tuple([progress]))
  ...
  def set_frame_and_progress(self, frame:'int'   , progress:'float'   ) -> None:
    ...
    self._ptr.call_with_return(328,tuple([frame, progress]))
  ...
  def set_speed_scale(self, speed_scale:'float'   ) -> None:
    ...
    self._ptr.call_with_return(329,tuple([speed_scale]))
