...
class OpenXRExtensionWrapper(py4godot_object.Object):
  ...
  def _get_requested_extensions(self, xr_version:'int'   ) -> typing.Union['Dictionary']:
    r''''''

    assert isinstance(xr_version, (int, float)), 'xr_version must be int or float'
    ...
    _ret._ptr = self._ptr.call_with_return(49,tuple([xr_version]))
    return _ret


  @functools.native_method
  def _prepare_view_configuration(self, view_count:'int'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(50,tuple([view_count]))

  @functools.native_method
  def _print_view_configuration_info(self, view:'int'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(51,tuple([view]))
  ...
  def _get_composition_layer(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(53,tuple([index]))
    return _ret
  ...
  def _get_composition_layer_order(self, index:'int'   ) -> typing.Union[int]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(54,tuple([index]))
    return _ret
  ...
  def _on_instance_created(self, instance:'int'   ) -> None:
    ...
    self._ptr.call_with_return(58,tuple([instance]))
  ...
  def _on_session_created(self, session:'int'   ) -> None:
    ...
    self._ptr.call_with_return(60,tuple([session]))
  ...
  def _on_pre_draw_viewport(self, viewport:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(65,tuple([viewport._ptr]))
  ...
  def _on_post_draw_viewport(self, viewport:'RID'   ) -> None:
    ...
    self._ptr.call_with_return(66,tuple([viewport._ptr]))
