...
class AnimationNodeOneShot(py4godot_animationnodesync.AnimationNodeSync):
  ...
  @property
  def abort_on_reset(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_aborted_on_reset()
    return _ret
  @abort_on_reset.setter
  def abort_on_reset(self,  value:'bool'):
    self.set_abort_on_reset(value)
  @property
  ...
  @functools.native_method
  def set_abort_on_reset(self, enable:'bool'   ) -> None:
    r''''''

    assert isinstance(enable, bool), 'enable must be bool'


    self.py__abort_on_reset = enable
    ...
    self._ptr.call_with_return(114,tuple([enable]))

  @functools.native_method
  def is_aborted_on_reset(self) -> typing.Union[bool]:
    r''''''
  ...
  def set_autorestart(self, active:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(116,tuple([active]))
  ...
  def set_autorestart_random_delay(self, time:'float'   ) -> None:
    ...
    self._ptr.call_with_return(120,tuple([time]))
