...
class FontVariation(py4godot_font.Font):
  ...
  @property
  def base_font(self) -> typing.Union['py4godot_systemfont.SystemFont','py4godot_font.Font','typing.Self','py4godot_fontfile.FontFile']:
    r''''''
  ...
  @functools.native_method
  def get_base_font(self) -> typing.Union['py4godot_systemfont.SystemFont','py4godot_font.Font','typing.Self','py4godot_fontfile.FontFile']:
    r''''''
