...
class AnimationNodeStateMachinePlayback(py4godot_resource.Resource):
  ...
  @functools.native_method
  def get_fading_from_play_position(self) -> typing.Union[float]:
    r'''
  ...
  @functools.native_method
  def get_fading_from_length(self) -> typing.Union[float]:
    r'''
  ...
  @functools.native_method
  def get_fading_position(self) -> typing.Union[float]:
    r'''
  ...
  @functools.native_method
  def get_fading_length(self) -> typing.Union[float]:
    r'''
