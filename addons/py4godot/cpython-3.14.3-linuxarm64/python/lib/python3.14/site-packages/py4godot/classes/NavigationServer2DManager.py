...
from py4godot.wrappers.wrappers import CPPNavigationServer2DManagerWrapper

_NavigationServer2DManager_singleton_instance = None

class NavigationServer2DManager(py4godot_object.Object):
  r'''
  ...
  def generate_wrapper(self):
    return CPPNavigationServer2DManagerWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = NavigationServer2DManager.__new__(NavigationServer2DManager)
  ...
  def cast(other:'Object'):
    ...
    cls = NavigationServer2DManager.construct_without_init()
    cls._ptr = CPPNavigationServer2DManagerWrapper()
  ...
  @staticmethod
  def instance():
    global _NavigationServer2DManager_singleton_instance
    if _NavigationServer2DManager_singleton_instance is None:
      singleton = NavigationServer2DManager()
      singleton._ptr = constructor(528,0, ())
      _NavigationServer2DManager_singleton_instance = singleton
    return _NavigationServer2DManager_singleton_instance
...
register_cast_function('NavigationServer2DManager', NavigationServer2DManager.cast)
register_class('NavigationServer2DManager', NavigationServer2DManager)
