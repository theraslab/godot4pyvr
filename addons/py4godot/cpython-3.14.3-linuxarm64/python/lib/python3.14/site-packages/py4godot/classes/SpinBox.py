...
class SpinBox(py4godot_range.Range):
  ...
  @property
  def custom_arrow_round(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_custom_arrow_rounding()
    return _ret
  @custom_arrow_round.setter
  def custom_arrow_round(self,  value:'bool'):
    self.set_custom_arrow_round(value)
  @property
  ...
  def set_horizontal_alignment(self, alignment:'int'  ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([alignment]))
  ...
  def set_suffix(self, suffix:'str'   ) -> None:
    ...
    self._ptr.call_with_return(464,tuple([py__string_suffix._ptr]))
  ...
  def set_prefix(self, prefix:'str'   ) -> None:
    ...
    self._ptr.call_with_return(466,tuple([py__string_prefix._ptr]))
  ...
  def set_custom_arrow_step(self, arrow_step:'float'   ) -> None:
    ...
    self._ptr.call_with_return(469,tuple([arrow_step]))
  ...
  @functools.native_method
  def set_custom_arrow_round(self, round:'bool'   ) -> None:
    r''''''

    assert isinstance(round, bool), 'round must be bool'


    self.py__custom_arrow_round = round
    ...
    self._ptr.call_with_return(471,tuple([round]))

  @functools.native_method
  def is_custom_arrow_rounding(self) -> typing.Union[bool]:
    r''''''
