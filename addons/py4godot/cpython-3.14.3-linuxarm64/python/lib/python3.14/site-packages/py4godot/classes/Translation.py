...
class Translation(py4godot_resource.Resource):
  ...
  @property
  def plural_rules_override(self) -> typing.Union[str]:
    r''''''
    _ret = self. get_plural_rules_override()
    return _ret
  @plural_rules_override.setter
  def plural_rules_override(self,  value:'str'):
    self.set_plural_rules_override(value)
  ...
  @functools.native_method
  def set_plural_rules_override(self, rules:'str'   ) -> None:
    r''''''

    assert(not rules is None)
    assert isinstance(rules, (str, String)), 'rules must be str or String'


    self.py__plural_rules_override = rules



    assert(isinstance(rules, (str, String)))
    py_string_rules = rules if isinstance(rules, StringName) else c_utils.py_string_to_string(rules)

    py__string_rules = utils.py_string_to_string(rules)
    py__string_rules.shouldBeDeleted = False


    self._ptr.call_with_return(89,tuple([py__string_rules._ptr]))

  @functools.native_method
  def get_plural_rules_override(self) -> typing.Union[str]:
    r''''''
