...
class Node2D(py4godot_canvasitem.CanvasItem):
  ...
  def set_position(self, position:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(272,tuple([position._ptr]))
  ...
  def set_rotation_degrees(self, degrees:'float'   ) -> None:
    ...
    self._ptr.call_with_return(274,tuple([degrees]))
  ...
  def set_skew(self, radians:'float'   ) -> None:
    ...
    self._ptr.call_with_return(275,tuple([radians]))
  ...
  def set_scale(self, scale:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(276,tuple([scale._ptr]))
  ...
  def rotate(self, radians:'float'   ) -> None:
    ...
    self._ptr.call_with_return(282,tuple([radians]))
  ...
  def move_local_x(self, delta:'float'   , scaled:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(283,tuple([delta, scaled]))
  ...
  def move_local_y(self, delta:'float'   , scaled:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(284,tuple([delta, scaled]))
  ...
  def translate(self, offset:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(285,tuple([offset._ptr]))
  ...
  def global_translate(self, offset:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(286,tuple([offset._ptr]))
  ...
  def apply_scale(self, ratio:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(287,tuple([ratio._ptr]))
  ...
  def set_global_position(self, position:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(288,tuple([position._ptr]))
  ...
  def set_global_rotation(self, radians:'float'   ) -> None:
    ...
    self._ptr.call_with_return(290,tuple([radians]))
  ...
  def set_global_rotation_degrees(self, degrees:'float'   ) -> None:
    ...
    self._ptr.call_with_return(291,tuple([degrees]))
  ...
  def set_global_skew(self, radians:'float'   ) -> None:
    ...
    self._ptr.call_with_return(294,tuple([radians]))
  ...
  def set_global_scale(self, scale:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(296,tuple([scale._ptr]))
  ...
  def set_transform(self, xform:'Transform2D'   ) -> None:
    ...
    self._ptr.call_with_return(298,tuple([xform._ptr]))
  ...
  def set_global_transform(self, xform:'Transform2D'   ) -> None:
    ...
    self._ptr.call_with_return(299,tuple([xform._ptr]))
  ...
  def look_at(self, point:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(300,tuple([point._ptr]))
  ...
  def get_angle_to(self, point:'Vector2'   ) -> typing.Union[float]:
    ...
    _ret = 0
    _ret = self._ptr.call_with_return(301,tuple([point._ptr]))
    return _ret
  ...
  def to_local(self, global_point:'Vector2'   ) -> typing.Union['Vector2']:
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(302,tuple([global_point._ptr]))
    return _ret
  ...
  def to_global(self, local_point:'Vector2'   ) -> typing.Union['Vector2']:
    ...
    _ret = Vector2.construct_without_init()
    _ret._ptr = self._ptr.call_with_return(303,tuple([local_point._ptr]))
    return _ret
  ...
  def get_relative_transform_to_parent(self, parent:'py4godot_node.Node'   ) -> typing.Union['Transform2D']:
    ...
    _ret._ptr = self._ptr.call_with_return(304,tuple([parent._ptr]))
    return _ret
