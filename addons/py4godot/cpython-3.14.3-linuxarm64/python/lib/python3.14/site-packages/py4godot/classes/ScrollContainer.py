...
class ScrollContainer(py4godot_container.Container):
  ...
  def set_h_scroll(self, value:'int'   ) -> None:
    ...
    self._ptr.call_with_return(442,tuple([value]))
  ...
  def set_v_scroll(self, value:'int'   ) -> None:
    ...
    self._ptr.call_with_return(444,tuple([value]))
  ...
  def set_vertical_custom_step(self, value:'float'   ) -> None:
    ...
    self._ptr.call_with_return(448,tuple([value]))
  ...
  def set_horizontal_scroll_mode(self, enable:'int'  ) -> None:
    ...
    self._ptr.call_with_return(450,tuple([enable]))
  ...
  def set_deadzone(self, deadzone:'int'   ) -> None:
    ...
    self._ptr.call_with_return(454,tuple([deadzone]))
  ...
  def set_scroll_hint_mode(self, scroll_hint_mode:'int'  ) -> None:
    ...
    self._ptr.call_with_return(456,tuple([scroll_hint_mode]))
  ...
  def set_tile_scroll_hint(self, tile_scroll_hint:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(458,tuple([tile_scroll_hint]))
  ...
  def ensure_control_visible(self, control:'py4godot_control.Control'   ) -> None:
    ...
    self._ptr.call_with_return(464,tuple([control._ptr]))
  ...
  def set_draw_focus_border(self, draw:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(465,tuple([draw]))
