...
class EditorSpinSlider(py4godot_range.Range):
  ...
  def flat(self,  value:'bool'):
    self.set_flat(value)
  @property
  def control_state(self) -> typing.Union[bool]:
    r''''''
    _ret = self. get_control_state()
    return _ret
  @control_state.setter
  def control_state(self,  value:'bool'):
    self.set_control_state(value)
  @property
  ...
  def set_label(self, label:'str'   ) -> None:
    ...
    self._ptr.call_with_return(462,tuple([py__string_label._ptr]))
  ...
  def set_read_only(self, read_only:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(466,tuple([read_only]))
  ...
  def set_flat(self, flat:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(468,tuple([flat]))
  ...
  def set_control_state(self, state:'int'  ) -> None:
    ...
    self._ptr.call_with_return(470,tuple([state]))

  @functools.native_method
  def get_control_state(self) -> typing.Union[int]:
    r''''''
  ...
  def set_hide_slider(self, hide_slider:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(472,tuple([hide_slider]))
  ...
  def set_editing_integer(self, editing_integer:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(474,tuple([editing_integer]))
