...
class Range(py4godot_control.Control):
  ...
  def _value_changed(self, new_value:'float'   ) -> None:
    ...
    self._ptr.call_with_return(438,tuple([new_value]))
  ...
  def set_value(self, value:'float'   ) -> None:
    ...
    self._ptr.call_with_return(445,tuple([value]))
  ...
  def set_min(self, minimum:'float'   ) -> None:
    ...
    self._ptr.call_with_return(447,tuple([minimum]))
  ...
  def set_max(self, maximum:'float'   ) -> None:
    ...
    self._ptr.call_with_return(448,tuple([maximum]))
  ...
  def set_step(self, step:'float'   ) -> None:
    ...
    self._ptr.call_with_return(449,tuple([step]))
  ...
  def set_page(self, pagesize:'float'   ) -> None:
    ...
    self._ptr.call_with_return(450,tuple([pagesize]))
  ...
  def set_as_ratio(self, value:'float'   ) -> None:
    ...
    self._ptr.call_with_return(451,tuple([value]))
  ...
  def set_allow_greater(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(456,tuple([allow]))
  ...
  def set_allow_lesser(self, allow:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(458,tuple([allow]))
  ...
  def share(self, with_:'py4godot_node.Node'   ) -> None:
    ...
    self._ptr.call_with_return(460,tuple([with_._ptr]))
