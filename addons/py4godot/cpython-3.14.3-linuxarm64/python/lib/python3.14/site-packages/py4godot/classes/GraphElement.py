...
class GraphElement(py4godot_container.Container):
  ...
  @property
  def scaling_menus(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_scaling_menus()
    return _ret
  @scaling_menus.setter
  def scaling_menus(self,  value:'bool'):
    self.set_scaling_menus(value)
  ...
  def set_resizable(self, resizable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(442,tuple([resizable]))
  ...
  def set_draggable(self, draggable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(444,tuple([draggable]))
  ...
  def set_selectable(self, selectable:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(446,tuple([selectable]))
  ...
  def set_selected(self, selected:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(448,tuple([selected]))
  ...
  @functools.native_method
  def set_scaling_menus(self, scaling_menus:'bool'   ) -> None:
    r''''''

    assert isinstance(scaling_menus, bool), 'scaling_menus must be bool'


    self.py__scaling_menus = scaling_menus
    ...
    self._ptr.call_with_return(450,tuple([scaling_menus]))

  @functools.native_method
  def is_scaling_menus(self) -> typing.Union[bool]:
    r''''''
  ...
  def set_position_offset(self, offset:'Vector2'   ) -> None:
    ...
    self._ptr.call_with_return(452,tuple([offset._ptr]))
