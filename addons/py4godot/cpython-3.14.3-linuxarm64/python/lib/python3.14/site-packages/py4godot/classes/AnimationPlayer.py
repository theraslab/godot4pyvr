...
class AnimationPlayer(py4godot_animationmixer.AnimationMixer):
  ...
  @functools.native_method
  def is_animation_active(self) -> typing.Union[bool]:
    r'''
  ...
  @functools.native_method
  def set_current_animation(self, animation:'object'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(246,tuple([py_stringname_animation._ptr]))

  @functools.native_method
  def get_current_animation(self) -> typing.Union['StringName']:
    r''''''
  ...
  @functools.native_method
  def set_assigned_animation(self, animation:'object'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(248,tuple([py_stringname_animation._ptr]))

  @functools.native_method
  def get_assigned_animation(self) -> typing.Union['StringName']:
    r''''''
  ...
  def queue(self, name:'object'   ) -> None:
    ...
    self._ptr.call_with_return(250,tuple([py_stringname_name._ptr]))

  @functools.native_method
  def get_queue(self) -> typing.Union['py4godot_stringnametypedarray.StringNameTypedArray']:
    r'''
  ...
  def set_speed_scale(self, speed:'float'   ) -> None:
    ...
    self._ptr.call_with_return(253,tuple([speed]))
  ...
  @functools.native_method
  def set_autoplay(self, name:'object'   ) -> None:
    r''''''
    ...
    self._ptr.call_with_return(256,tuple([py_stringname_name._ptr]))

  @functools.native_method
  def get_autoplay(self) -> typing.Union['StringName']:
    r''''''
  ...
  def set_section_with_markers(self, start_marker:'object' = None  , end_marker:'object' = None  ) -> None:
    ...
    self._ptr.call_with_return(262,tuple([py_stringname_start_marker._ptr, py_stringname_end_marker._ptr]))
  ...
  def set_section(self, start_time:'float' =-1  , end_time:'float' =-1  ) -> None:
    ...
    self._ptr.call_with_return(263,tuple([start_time, end_time]))
  ...
  def seek(self, seconds:'float'   , update:'bool' =False  , update_only:'bool' =False  ) -> None:
    ...
    self._ptr.call_with_return(268,tuple([seconds, update, update_only]))
  ...
  def set_root(self, path:'object'   ) -> None:
    ...
    self._ptr.call_with_return(273,tuple([py_nodepath_path._ptr]))
