...
class MissingNode(py4godot_node.Node):
  ...
  @property
  def recording_signals(self) -> typing.Union[bool]:
    r''''''
    _ret = self. is_recording_signals()
    return _ret
  @recording_signals.setter
  def recording_signals(self,  value:'bool'):
    self.set_recording_signals(value)
  ...
  @functools.native_method
  def set_recording_signals(self, enable:'bool'   ) -> None:
    r''''''

    assert isinstance(enable, bool), 'enable must be bool'


    self.py__recording_signals = enable
    ...
    self._ptr.call_with_return(186,tuple([enable]))

  @functools.native_method
  def is_recording_signals(self) -> typing.Union[bool]:
    r''''''
