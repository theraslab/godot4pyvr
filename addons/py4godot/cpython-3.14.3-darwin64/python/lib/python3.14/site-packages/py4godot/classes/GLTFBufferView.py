...
class GLTFBufferView(py4godot_resource.Resource):
  ...
  def from_dictionary(dictionary:'Dictionary'   ) -> typing.Union['typing.Self']:
    ...
    _ret = GLTFBufferView.construct_without_init()
    _ret._ptr = static_method(356,1,tuple([dictionary._ptr]))
  ...
  def set_buffer(self, buffer:'int'   ) -> None:
    ...
    self._ptr.call_with_return(80,tuple([buffer]))
  ...
  def set_byte_offset(self, byte_offset:'int'   ) -> None:
    ...
    self._ptr.call_with_return(82,tuple([byte_offset]))
  ...
  def set_byte_length(self, byte_length:'int'   ) -> None:
    ...
    self._ptr.call_with_return(84,tuple([byte_length]))
  ...
  def set_byte_stride(self, byte_stride:'int'   ) -> None:
    ...
    self._ptr.call_with_return(86,tuple([byte_stride]))
  ...
  def set_indices(self, indices:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(88,tuple([indices]))
  ...
  def set_vertex_attributes(self, is_attributes:'bool'   ) -> None:
    ...
    self._ptr.call_with_return(90,tuple([is_attributes]))
